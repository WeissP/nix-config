(with-eval-after-load 'latex
  ...
  (wks-define-key
   ...
   '(
     ...
     ("m s f" . (weiss-latex-insert-mathsf (weiss--quick-add-latex-style "mathsf")))
     ("m b f" . (weiss-latex-insert-mathbf (weiss--quick-add-latex-style "mathbf")))
...
(provide 'weiss_latex_quick-insert)

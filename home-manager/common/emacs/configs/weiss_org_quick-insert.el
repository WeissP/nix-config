(with-eval-after-load 'org
  ...
  (wks-define-key
   ...
   '(
     ...
     ("r" . (weiss-org-babel-insert-rust (weiss-insert-pair "#+begin_src R :session *R* :results output" "#+end_src" t)))
     ...
     ("n" . (weiss-org-babel-insert-nix (weiss-insert-pair "#+begin_src nix" "#+end_src" t)))

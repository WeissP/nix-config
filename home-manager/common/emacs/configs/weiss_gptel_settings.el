(with-eval-after-load 'gptel
  (setq
   ...
   '(
     (Academic-Writing-Paraphrasing . "You are a large language model and a writing assistant. Paraphrase the following sentence for use in an academic paper.")
     (Conversation-Paraphrasing . "You are a large language model and a writing assistant. Paraphrase the following sentence for use in daily conversation.")

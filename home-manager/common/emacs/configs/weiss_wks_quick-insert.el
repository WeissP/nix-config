...
(defun weiss-global-insert-pair-alist(new-line)
  `(("<tab>" .
    ...
    ("k" .
     (,(if new-line 'weiss-insert-bracket-new-line 'weiss-insert-bracket)
      (weiss-insert-pair "[" "]" ,new-line)))
    ("l" .
     (,(if new-line 'weiss-insert-brace-new-line 'weiss-insert-brace)
      (weiss-insert-pair "{" "}" ,new-line)))
    ("i" .
    ...
    ("~" .
     (,(if new-line 'weiss-insert-wavy-new-line 'weiss-insert-wavy)
      (weiss-insert-pair "~" "~" ,new-line)))
    ("=" .
     (,(if new-line 'weiss-insert-equals-new-line 'weiss-insert-equals)
      (weiss-insert-pair "=" "=" ,new-line)))
    ("a" .
     (,(if new-line 'weiss-insert-bar-new-line 'weiss-insert-bar)
      (weiss-insert-pair "|" "|" ,new-line)))
    ("c" .
     (weiss-insert-markdown-quote-block
      (weiss-insert-pair "```" "```" t)))
    ("q" .
     (,(if new-line 'weiss-insert-markdown-quote-new-line 'weiss-insert-markdown-quote)
      (weiss-insert-pair "`" "`" ,new-line)))
    ("w" .
     (,(if new-line 'weiss-insert-elisp-quote-new-line 'weiss-insert-elisp-quote)
      (weiss-insert-pair "`" "'" ,new-line)))
    ("s" .
     (,(if new-line 'weiss-insert-star-new-line 'weiss-insert-star)
      (weiss-insert-pair "*" "*" ,new-line)))
    ("/" .
    ...
    ("$" .
     (,(if new-line 'weiss-insert-dollar-new-line 'weiss-insert-dollar)
      (weiss-insert-pair "$" "$" ,new-line)))
    ("7" .
     (,(if new-line 'weiss-insert-and-new-line 'weiss-insert-and)
      (weiss-insert-pair "&" "&" ,new-line)))
    ("m" .
     (,(if new-line 'weiss-insert-angle-bracket-new-line 'weiss-insert-angle-bracket)
      (weiss-insert-pair "<" ">" ,new-line)))
    ("<deletechar>" .
     (,(if new-line 'weiss-insert-back-slash-new-line 'weiss-insert-back-slash)
      (weiss-insert-pair "\\" "\\" ,new-line))))
  )

(defun weiss-global-insert-escape-pair-alist(new-line)
  `(("j" .
     (,(if new-line 'weiss-insert-escape-paren-new-line 'weiss-insert-escape-paren)
      (weiss-insert-pair "\\(" "\\)" ,new-line)))
    ("k" .
     (,(if new-line 'weiss-insert-escape-bracket-new-line 'weiss-insert-escape-bracket)
      (weiss-insert-pair "\\[" "\\]" ,new-line)))
    ("l" .
     (,(if new-line 'weiss-insert-escape-brace-new-line 'weiss-insert-escape-brace)
      (weiss-insert-pair "\\{" "\\}" ,new-line)))
    ("i" .

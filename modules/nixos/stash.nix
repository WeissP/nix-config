    ...
    services.myStash = {
      ...
      username = mkOption {
        ...
        description = ''
          ...
          ::: {.warning}
            This option takes precedence over {option}`services.myStash.settings.username`
          ::
      ...
      passwordFile = mkOption {
        ...
        description = ''
          ...
          ::: {.warning}
            This option takes precedence over {option}`services.myStash.settings.password`
          ::
      ...
      mutableSettings = mkOption {
        description = ''
          ...
          If `false`, Any config changes done from within Stash UI will be temporary and reset to those defined in {option}`services.myStash.settings` upon `Stash.service` restart.
          If `true`, the {option}`services.myStash.settings` will only be used to initialize the Stash configuration if it does not exist, and are subsequently ignored.
        '';
        type = types.bool;
        default = true;
      };
